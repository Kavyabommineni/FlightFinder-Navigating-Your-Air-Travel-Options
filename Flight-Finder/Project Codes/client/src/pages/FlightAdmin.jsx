...
const FlightAdmin = () => {
  ...
  <marquee behavior="alternative" direction="left" scrollamount="10">
    ✈️ Welcome, {localStorage.getItem('username')}---  A true flight owner doesn’t just invest in aircraft—they invest in experiences, destinations, and connections that change lives.✈️
  </marquee>
</div>
